...
class PickRoleVC: UIViewController {
    ...
    private let healerDesc: NSMutableAttributedString = {
        ...
        let attr2 = [NSAttributedString.Key.font : UIFont(name: "Poppins-Regular", size: 16)]
			let attString = NSMutableAttributedString(string: boldText, attributes: attr1 as [NSAttributedString.Key : Any])
			let regString = NSMutableAttributedString(string: regText, attributes: attr2 as [NSAttributedString.Key : Any])
			let attString2 = NSMutableAttributedString(string: boldText2, attributes: attr1 as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any])
			let regString2 = NSMutableAttributedString(string: regText2, attributes: attr2 as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any])
        attString.append(regString)
